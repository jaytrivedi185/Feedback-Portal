...
<h3 style="color: white; padding-left: 320px;">UPDATE FACULTY</h3>
<body id="register">
    <div class="container">
        <div class="row tm-register-row">
           <p style="color: white; padding-left:50px;">NOTE: &nbsp;First enter name to Update other details</p>
                <form action="facultyupdated.php" method="post">
                    <div class="mb-2">
                        <label class="mr-4">
                            <input class="with-gap" name="title" type="radio" value="mr"></input>
                            <span>Mr.</span>
                        </label>
                        <label class="mr-4">
                            <input class="with-gap" name="title" type="radio" value="ms"></input>
                            <span>Ms.</span>
                        </label>
                        <label>
                            <input class="with-gap" name="title" type="radio" value="mrs"></input>
                            <span>Mrs.</span>
                        </label>
                    </div>
