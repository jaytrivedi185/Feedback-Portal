...
echo "<th>Enroll</th><th>Name</th><th>Mobile</th><th>Branch</th><th>Username</th><th>Password</th>";
while($row = mysqli_fetch_array($result)){   
echo "<tr><td>" . $row['enroll'] . "</td><td>" . $row['name'] . "</td><td>" . $row['mobile'] . "</td><td>" . $row['branch'] . "</td><td>" . $row['username'] . "</td><td>" . $row['password'] . "</td></tr>";  
}
